...
class _EditAddressState extends State<EditAddress> {
  ...
  initState(){
    super.initState();
    name.text = widget.addressModel.name!;
    phoneNum.text = widget.addressModel.phoneNo!;
    pincode.text = widget.addressModel.pincode!;
    state.text = widget.addressModel.state!;
    city.text = widget.addressModel.city!;
    houseNo.text = widget.addressModel.houseNo!;
    area.text = widget.addressModel.area!;
    typeOfAddress = widget.addressModel.addressType!;
  }
                    ...
                    child: TextButton(
                      ...
                      onPressed: () async{
                        ...
                        if(!validateName && !validatePhone && !validatePin && !validateState && !validateCity && !validateHouse && !validateArea ){
                          ...
                          var result = await _userService.UpdateAddress(addressModel);
                          if(result >= 1){
